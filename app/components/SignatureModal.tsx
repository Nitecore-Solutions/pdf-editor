...
export const SignatureModal: React.FC<SignatureModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xs p-4 animate-in fade-in duration-150 select-none">
      <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden border border-gray-200 flex flex-col">
        {/* Modal Header */}
        ...
        <div className="flex border-b border-gray-200 bg-gray-50 px-6 pt-2">
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2.5 font-medium text-sm border-b-2 transition cursor-pointer ${
              activeTab === 'draw'
        ...
        <div className="p-6 flex-1">
          ...
          {activeTab === 'draw' && (
            <div>
              ...
              <div className="flex justify-end mt-2">
                <button
                  onClick={clearCanvas}
                  className="flex items-center space-x-1 text-xs text-gray-500 hover:text-red-600 transition"
                >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-2.5 pt-2">
                {[
                  ...
                  >
                    <div 
                      className="text-xl truncate tracking-wide"
          ...
          {activeTab === 'upload' && (
            <div className="space-y-3">
              <label className="border-2 border-dashed border-gray-300 rounded-xl p-6 flex flex-col items-center justify-center cursor-pointer hover:border-emerald-400 bg-gray-50/50 transition">
                <input
                  type="file"
                ...
                <span className="text-xs text-gray-400 mt-1">Transparent background recommended</span>
              </label>

              {uploadedImage && (
                <div className="p-3 bg-gray-100 rounded-xl flex items-center justify-center max-h-32 overflow-hidden border border-gray-200">
        ...
        <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-end space-x-3">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-200/60 rounded-lg transition cursor-pointer"
          >
            Cancel
          </button>
          <button
            onClick={handleSave}
            className="px-5 py-2 text-sm font-semibold text-white bg-emerald-500 hover:bg-emerald-600 rounded-lg shadow-sm transition flex items-center space-x-1.5 cursor-pointer"
          >
