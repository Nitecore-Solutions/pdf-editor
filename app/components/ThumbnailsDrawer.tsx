...
export const ThumbnailsDrawer: React.FC<ThumbnailsDrawerProps> = ({
  ...
  return (
    <>
      ...
      <div 
        onClick={onClose}
        className="fixed inset-0 bg-black/30 backdrop-blur-2xs z-45 md:hidden animate-in fade-in"
      />

      <div className="fixed inset-y-0 right-0 z-50 w-72 sm:w-80 max-w-[85vw] bg-white shadow-2xl border-l border-gray-200 flex flex-col animate-in slide-in-from-right duration-200 select-none">
        {/* Drawer Header */}
